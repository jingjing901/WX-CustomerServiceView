var cityList=[
    ["北京","东城区", "西城区", "海淀区", "朝阳区", "丰台区", "石景山区", "通州区", "顺义区", "房山区", "大兴区", "昌平区", "怀柔区", "平谷区", "门头沟区", "延庆县", "密云县"],
    [ "上海","浦东新区", "徐汇区", "长宁区", "普陀区", "闸北区", "虹口区", "杨浦区", "黄浦区", "卢湾区", "静安区", "宝山区", "闵行区", "嘉定区", "金山区", "松江区", "青浦区", "南汇区", "奉贤区", "崇明县"],
    [ "天津","河东", "南开", "河西", "河北", "和平", "红桥", "东丽", "津南", "西青", "北辰", "塘沽", "汉沽", "大港", "蓟县", "宝坻", "宁河", "静海", "武清"],
    ["重庆", "渝中区", "大渡口区", "江北区", "沙坪坝区", "九龙坡区", "南岸区", "北碚区", "万盛区", "双桥区", "渝北区", "巴南区", "万州区", "涪陵区", "黔江区", "长寿区", "江津区", "合川区", "永川区", "南川区"],
    [ "浙江","南京", "无锡", "常州", "徐州", "苏州", "南通", "连云港", "淮安", "扬州", "盐城", "镇江", "泰州", "宿迁"],
    ["江苏", "杭州", "宁波", "温州", "嘉兴", "湖州", "绍兴", "金华", "衢州", "舟山", "台州", "利水"],
    ...
    [ "新疆","西宁", "海东地区", "海北藏族自治州", "黄南藏族自治州", "海南藏族自治州", "果洛藏族自治州", "玉树藏族自治州", "海西蒙古族藏族自治州"],
    ["青海","乌鲁木齐", "奎屯", "石河子", "昌吉", "吐鲁番", "库尔勒", "阿克苏", "喀什", "伊宁", "克拉玛依", "塔城", "哈密", "和田", "阿勒泰", "阿图什", "博乐"],
...
function setProvince()
{
    ...
    //var opt=new Option("zhangsan","zhangsan");
    //selProvince.options.add(opt);
    for(var i=0;i<cityList.length;i++)
    {
        var opt=new Option(cityList[i][0],cityList[i][0]);
        selProvince.options.add(opt);
    }
}
...
function setCity() {
    ...
    //alert(Province);
    for (var i = 0; i < cityList.length; i++) {
        if (Province == cityList[i][0]) {
            for (var j = 1; j < cityList[i].length; j++) {
                var opt = new Option(cityList[i][j], cityList[i][j]);
...
$("#appAdd").click(function(){
    $("#pagetwo").css("opacity","0.3");
    $("#pagetwo").css("disabled","true");
    $(".add").css("display","block");
})
$("#cancle").click(function(){
    $("#pagetwo").css("opacity","1");
    $("#pagetwo").css("disabled","false");
...
$("#confirm").click(function(){
    ...
    $("#pagetwo").css("disabled","false");
    $(".add").css("display","none");
	$("#appAdd").val(selProvince.value+selcity.value);
})